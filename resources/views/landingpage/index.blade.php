                ...
                <li class="nav-item submenu dropdown">
                  ...
                  >
                   <!-- <ul class="dropdown-menu">
                       <li class="nav-item col-md-4 col-sm-4" style="float:left">
                        
                          <a class="nav-link" href="courses.html">Acturial Sciences</a>
                          <a class="nav-link" href="courses.html">Acturial Sciences</a>
                          <a class="nav-link" href="courses.html">Acturial Sciences</a>
                          <a class="nav-link" href="courses.html">Acturial Sciences</a>
                          <a class="nav-link" href="courses.html">Acturial Sciences</a>
                  ...
                  <ul class="dropdown-menu">
                    @foreach($home_menu as $careerkey => $home_menu)
                    <li class="nav-item col-sm-4 col-lg-4 col-md-4" style="float:left;">
                      <?php $careerCount = 1;
                            $lastCount = 13;
                      ?>
                      <a class="nav-link" href="careerlibrary/{{$home_menu->career_name}}" style="font-size: 0.7rem;float:left">{{$home_menu->career_name}}</a>
                    </li>
                    @endforeach
